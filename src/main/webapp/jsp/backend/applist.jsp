...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/backend/gettype.html">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							...
							<a href="${pageContext.request.contextPath }/backend/excel.html">导出表格</a>
					</div>
					<div class="col-sm-7">
