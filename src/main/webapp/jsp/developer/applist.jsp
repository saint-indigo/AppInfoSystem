...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/developer/gettype.html">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryStatus" class="form-control">
									<c:if test="${typelist != null }">
									   ...
									   <c:forEach var="dataDictionary" items="${typelist}">
									  <c:if test="${dataDictionary.typeCode == 'APP_STATUS' }">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="queryFlatformId" class="form-control">
									<c:if test="${typelist != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="dataDictionary" items="${typelist}">
									   		<c:if test="${dataDictionary.typeCode == 'APP_FLATFORM' }">
									   		<option value="${dataDictionary.valueId}">${dataDictionary.valueName}</option>
									   		</c:if>
									   </c:forEach>
									</c:if>
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="queryCategoryLevel1" name="queryCategoryLevel1" class="form-control">
									<c:if test="${Firstlist != null }">
									   <option value="">--请选择--</option>
									   <c:forEach var="appCategory" items="${Firstlist}">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/developer/jumpappadd.html" class="btn btn-success btn-sm">新增APP基础信息</a>
							...
							<tbody>
								<c:forEach var="appInfo" items="${AppList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<td>${appInfo.pingtai }</td>
										<td>${appInfo.lei1 } -> ${appInfo.lei2 } -> ${appInfo.lei3 }</td>
										<td><span id="appInfoStatus${appInfo.id}">${appInfo.zhuangtai }</span></td>
